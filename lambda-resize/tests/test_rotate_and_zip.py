...
def test_rotate_and_zip_zero_steps_builds_zip_without_rotation(monkeypatch, fake_env):
    ...
    def fake_video_frames_to_zip_av(data, jpeg_quality=60, progress_cb=None, progress_every=5, target_wh=None):  # noqa: D401
...
def test_rotate_and_zip_one_step_rotates_and_builds_zip(monkeypatch, fake_env):
    ...
    def fake_video_frames_to_zip_av(data, jpeg_quality=60, progress_cb=None, progress_every=5, target_wh=None):
        calls["zip_args"] = {
            "data": data,
            "jpeg_quality": jpeg_quality,
            "progress_cb_is_none": progress_cb is None,
