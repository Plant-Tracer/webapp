...
- playback/analysis metadata: `fps`, `fpm`, `width`, `height`,
  `frame_height_px`, `trackpoint_origin`,
...
| Untraced MP4 | `analysis_mp4.urn`, ending in `_{sha256}_scaled.mp4` | Validated playback/tracing derivative owned by lambda-resize; checksum-addressed bytes remain immutable across attempts |
