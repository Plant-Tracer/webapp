 ...
 */
function upload_movie_post(...args) {
  return perform_movie_upload(...args).finally(release_upload_preview);
}

async function perform_movie_upload(movie_title, description, movieFile, research_use, credit_by_name, attribution_name, fpm, rotation = 0)
{
