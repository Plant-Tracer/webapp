...
SUPER_ROLE_STATE_EMAIL = super_roles.SUPER_ROLE_STATE_EMAIL
SUPERADMIN_USER_IDS = super_roles.SUPERADMIN_USER_IDS
SUPER_ROLE_STATE_VERSION = super_roles.SUPER_ROLE_STATE_VERSION
SUPER_ROLE_TRANSACTION_RETRIES = super_roles.SUPER_ROLE_TRANSACTION_RETRIES

SuperRoleChange = super_roles.SuperRoleChange
SuperRoleState = super_roles.SuperRoleState
ConcurrentSuperRoleChange = super_roles.ConcurrentSuperRoleChange
...
superadmin_user_ids = super_roles.superadmin_user_ids
read_super_role_state = super_roles.read_super_role_state
reconcile_super_role_state = super_roles.reconcile_super_role_state
transact_super_role_change = super_roles.transact_super_role_change
validate_super_role = super_roles.validate_super_role
set_super_role_by_email = super_roles.set_super_role_by_email
